#credit to [https://github.com/JMHReif/marvel-api-import/blob/master/import-neo4j-json.py]
#my goal is to use this script to download all marvel api data and develop draft dash viz with json files
